...
class Model(nn.Module):
    def __init__(self, num_class=2, num_point=18, num_person=1, graph=None, graph_args=dict(), in_channels=4,
    ...
    def forward(self, x, y):
        groups = []
        print("JOINT LABEL =", self.joint_label)
        print("TYPE =", type(self.joint_label))
        print("LEN =", len(self.joint_label))
